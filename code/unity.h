...
/* --- */
/* =====[ Added by MJG on 2019-10-03 ]===== */
#define TEST_ASSERT_CALL_LISTS_MATCH_MESSAGE(call_list_s)                                               UNITY_TEST_ASSERT( (RanAsHoped(call_list_s)), __LINE__, (WhyDidItFail(call_list_s)))
#define TEST_ASSERT_CALL_LISTS_MATCH_MESSAGE_HISTORY(call_list_s)                                               UNITY_TEST_ASSERT( (RanAsHoped(call_list_s)), __LINE__, (ListAllCalls(call_list_s)))
/* --- */
